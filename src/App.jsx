    ...
    <div className="sticky top-0 z-20 border-b border-black/5 bg-[rgba(247,247,245,0.85)] backdrop-blur-md">
      <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4 md:px-10">
        <div className="flex items-center gap-3">
          <div className="rounded-lg border border-black/8 bg-white px-3 py-2 text-sm font-semibold tracking-[-0.03em] shadow-[0_8px_24px_rgba(0,0,0,0.04)]">
            SYNTA
          </div>
          <div className="hidden text-sm text-black/45 md:block">Retention Revenue Offer</div>
        </div>
        <button
...
function HeroStat({ value, label }) {
  return (
    <div className="rounded-2xl border border-black/6 bg-white p-5 text-left">
      <div className="text-2xl font-semibold tracking-[-0.04em] text-black md:text-3xl">{value}</div>
      <div className="mt-2 text-sm leading-6 text-black/50">{label}</div>
    </div>
  );
}
